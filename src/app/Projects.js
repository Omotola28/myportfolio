...
import FlutterApp from './../components/resources/hmq.gif'
                    ...
                    <div className="tile is-ancestor">
                        <div className="tile is-4 is-vertical is-parent">
                            ...
                            <div className="tile is-child box">
                                <article className="tile is-child box">
                                    <p className="title has-text-left">Flutter Application</p>
                                    <p className="subtitle has-text-justified">Built a Flutter application for my final year project. The aim of the application was to synchronize users highlights from third party 
                             services like Medium, Kindle and Instapaper. The application was built with the Flutter 
                             SDK and a Firebase Backend</p>
                                    <figure className="image is-4by3">
                                        <img alt='Photosynthesis game' src={FlutterApp} />
                                    </figure>
                                    <footer className="card-footer">
                                        <p className="card-footer-item">
