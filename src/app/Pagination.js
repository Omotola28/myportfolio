            ...
            { pages.map((page, index) => {
              ...
              return (
                <li key={index} className={`page-item${ currentPage === page ? ' active' : ''}`}>
                  <a className="pagination-link" href="#" onClick={ this.handleClick(page) }>{ page }</a>
                </li>
              );
...
//pageLimit - No of records to be shown per page 
//pageNeighBours: number of additional page numbers to be shown on each side of the current page. The minimum value is 1 and the maximum is 2 if not specified it defaults to 0.